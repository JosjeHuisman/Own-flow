...
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

git remote set-url origin https://github.com/JosjeHuisman/RNAseqT.git

git remote set-url origin https://github.com/JosjeHuisman/RNA_seq_test_workflow.git
